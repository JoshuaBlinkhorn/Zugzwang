...
class TestGetSolutionNodes:
    ...
    def test_white_from_starting_position(self):
        ...
        chp_filepath = os.path.join(
            TEST_CATEGORY_PATH, "white-from-starting-position.chp"
        )
        with open(chp_filepath) as chapter_file:
            game = chess.pgn.read_game(chapter_file)
    ...
    def test_alternative(self):
        ...
        # in perspective
        chp_filepath = os.path.join(TEST_CATEGORY_PATH, "alternative.chp")
        with open(chp_filepath) as chapter_file:
            game = chess.pgn.read_game(chapter_file)
    ...
    def test_blunder_and_alternative(self):
        ...
        chp_filepath = os.path.join(TEST_CATEGORY_PATH, "blunder-and-alternative.chp")
        with open(chp_filepath) as chapter_file:
            game = chess.pgn.read_game(chapter_file)
