...
class TestZugTrainingPositionPresenter:
    ...
    @pytest.mark.parametrize(
        ...
        [
            (("", ""), ZugQueueItem.SUCCESS),
            (
                ("azby", "bcty", "asfhwrqreqrw", "", "assirtt", "aq", ""),
                ZugQueueItem.SUCCESS,
            ),
            (
                ("azby", "f", "asfhwas,", "", "assirtt", "f", "h", ""),
                ZugQueueItem.SUCCESS,
            ),
            (("\n", "", "\n", ""), ZugQueueItem.SUCCESS),
            (("", "q"), ZugQueueItem.QUIT),
