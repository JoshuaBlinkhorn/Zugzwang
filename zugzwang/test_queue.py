...
class TestZugQueue:
    ...
    @pytest.mark.parametrize("insertion_index", list(range(10)))
    ...
    @pytest.mark.parametrize("insertion_radius", list(range(11)))
    def test_insert_with_radius(self, insertion_radius):
        ...
        for i in range(50 - insertion_radius, 50 + insertion_radius + 1):
            assert any(queue.items[i] == inserted_item for queue in queues)
