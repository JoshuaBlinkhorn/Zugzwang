...
class TestZugRootSolutionNodes():
    ...
    def test_unreachable(self, root_data_black_perspective):
    ...
    def test_basic_blunder(self, root_data_black_perspective):
    ...
    def test_blunders_and_branching(self, root_data_black_perspective):
    ...
    def test_blunder_and_unreachable(self, root_data_black_perspective):
    ...
    def test_double_blunders(self, root_data_black_perspective):
    ...
    def test_white_from_starting_position(self, root_data_white_perspective):
        ...
        game.comment = root_data_white_perspective.make_json()
        root = ZugRoot(game)
